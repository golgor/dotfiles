...
-- Restored from pre-quattro looknfeel.conf.
hl.config({
  decoration = {
    -- Use round window corners.
    rounding = 8,
  ...
  dwindle = {
    -- Manages the window width when splitting. If it is "too slim", toggle
    -- top/bottom instead of left/right. Mostly for the case of more than 2
